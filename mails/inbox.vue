...
<i class="fas fa-sort-down  giconsmall "></i>
      ...
      <div class="mailstabs">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item mailssocial">
            <a
              class="mailssociallink"
              id="social-tab"
              data-toggle="tab"
              href="#social"
              role="tab"
          ...
          <li class="nav-item mailspromotions">
            <a
              class="mailspromotionslink"
              id="promotions-tab"
              data-toggle="tab"
              href="#promotions"
              role="tab"
